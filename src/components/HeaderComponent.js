                ...
                <header id="header">
                    <div className="container clearfix">
                        ...
                        <div className="nav-box">
                            ...
                            <ul>
                                <li>
                                    <a href="#" className="main-btn" title="main menu">COFFEE</a>
                                ...
                                <li>
                                    <a href="#" className="main-btn" title="main menu">MENU</a>
                                ...
                                <li>
                                    <a href="#" className="main-btn" title="main menu">STORE</a>
                                ...
                                <li>
                                    <a href="#" className="main-btn" title="main menu">RESPONSIBILITY</a>
                                ...
                                <li>
                                    <a href="#" className="main-btn" title="main menu">STARBUCKS REWARDS</a>
                                ...
                                <li>
                                    <a href="#" className="main-btn" title="main menu">WHAT'S NEW</a>
                            ...
                            <div id="mobile">
                                <ul>
                                    <li><a href="#" className="login-btn"><img src="./images/icon_user_m.png" alt="유저 아이콘"/></a></li>
                                    <li><a href="#" className="maps-btn"><img src="./images/icon_spot_m.png" alt="위치 아이콘"/></a></li>
                                    <li><a href="#" className="berger-btn"><img src="./images/btn_berger_m.png" alt="버거 메뉴 아이콘"/></a></li>
                                </ul>
                            </div>
